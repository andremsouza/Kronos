...
public class MainGUI extends JFrame {
	 ...
	 * Cria a frame.
	 */
	public MainGUI(final int privileges) {
		try {
		...
		mntmSair.setSelectedIcon(
				new ImageIcon(MainGUI.class.getResource("/javax/swing/plaf/metal/icons/ocean/close-pressed.gif")));
		...
		panelParam.setBorder(new TitledBorder(null, "Par\u00E2metros para C\u00E1lculo", TitledBorder.CENTER,
		...
		panelMatricula.setBorder(new TitledBorder(new LineBorder(new Color(184, 207, 229)), "Status da Matr\u00EDcula",
				TitledBorder.LEADING, TitledBorder.TOP, null, new Color(51, 51, 51)));
		panelParam.add(panelMatricula, "cell 1 0,grow");
		panelMatricula.setLayout(new MigLayout("", "[126px,grow,fill]", "[26px,grow]"));

		final JToggleButton tglbtnMatrculaPaga = new JToggleButton("Matr\u00EDcula Paga");
		...
		panelDataTerm.setBorder(
				new TitledBorder(null, "Data de T\u00E9rmino", TitledBorder.LEADING, TitledBorder.TOP, null, null));
		...
		comboBoxMes.setModel(new DefaultComboBoxModel<String>(new String[] { "JANEIRO", "FEVEREIRO", "MAR\u00C7O",
				"ABRIL", "MAIO", "JUNHO", "JULHO", "AGOSTO", "SETEMBRO", "OUTUBRO", "NOVEMBRO", "DEZEMBRO" }));
		panelDataTerm.add(comboBoxMes, "cell 1 1,alignx center,aligny center");

		JPanel panel = new JPanel();
		panel.setBorder(new TitledBorder(UIManager.getBorder("TitledBorder.border"), "Integral", TitledBorder.LEADING,
		...
		btnCalcular.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				double a = operations.valorProporcional(comboBoxDia.getSelectedIndex() + 1,
						comboBoxMes.getSelectedIndex() + 1, cat, cdata, integral, mat);
