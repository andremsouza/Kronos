...
/**
 * Frame que permite visualizar e editar dados sobre os cursos
 * extracurriculares.
 *
 */
public class Curso extends JFrame {
	...
	private void initialize(int privileges) {
			...
			btnAdd.addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent e) {
					...
					if (i != rowCount) {
						...
						JOptionPane.showMessageDialog(null, "Curso precisa ter no m�nimo 3 caracteres.", "Erro",
						...
						JOptionPane.showMessageDialog(null, "Curso '" + curso + "' criado com sucesso.",
		...
		if (privileges != 1)
			btnEdit.addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent e) {
					...
					rowCount = ((DefaultTableModel) table.getModel()).getRowCount();
					for (i = 0; i < rowCount; i++)
						if (((String) ((DefaultTableModel) table.getModel()).getValueAt(i, 0)).compareTo(curso) == 0)
							break;
					if (i == rowCount) {
						...
						JOptionPane.showMessageDialog(null, "Curso '" + curso + "' editado com sucesso.",
								"Opera��o sucedida", JOptionPane.INFORMATION_MESSAGE);
						((DefaultTableModel) table.getModel())
								.setValueAt(new Double(Double.parseDouble(novoValor.replace(',', '.'))), i, 1);
						tFEditCurso.setText("");
			...
			btnRem.addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent e) {
					...
					if (i == rowCount) {
						...
						JOptionPane.showMessageDialog(null, "Curso '" + curso + "' removido com sucesso.",
								"Opera��o sucedida", JOptionPane.INFORMATION_MESSAGE);
		...
		if (privileges == 1) { // Funcionario nao poderam alterar cursos, apenas
			// ver
		...
		if (((DefaultTableModel) table.getModel()).getRowCount() * 16 + 329 > bounds.height)
			setBounds(0, 0, 770, bounds.height);
		else
			setBounds(0, 0, 770, ((DefaultTableModel) table.getModel()).getRowCount() * 16 + 329);
		...
		/* Diferen�a entre privil�gios(T�tulo) */
