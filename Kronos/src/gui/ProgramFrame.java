...
public class ProgramFrame extends JFrame {
	...
	public ProgramFrame(int privileges) {
		...
		panel_2.setBorder(BorderFactory.createTitledBorder(BorderFactory.createLineBorder(Color.blue),
				"Taxa de Matr�cula Paga?"));
		panel.add(panel_2);
		...
		/* Diferen�a entre privil�gios */
		title = "Kronos - C�lculo de ?(";
		switch (privileges) {
		case 1:
			title += "Funcion�rio";
